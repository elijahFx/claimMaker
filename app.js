...
document.addEventListener("DOMContentLoaded", function() {
    ...
    document.querySelector("#price").addEventListener('blur', function (e) {
            let input = e.target;
            input.value = formatPrice(input.value);
        })

    document.querySelector("#sorazm").addEventListener('blur', function (e) {
            let input = e.target;
            input.value = formatPrice(input.value);
        }) 
        
    document.querySelector("#vozmesh").addEventListener('blur', function (e) {
            let input = e.target;
            input.value = formatPrice(input.value);
        })   

    document.querySelector("#moralAmount").addEventListener('blur', function (e) {
            let input = e.target;
            input.value = formatPrice(input.value);
        })
    ...
    selectedTypeOptionInput.addEventListener('change', function() {
        selectedOptionType = this.options[this.selectedIndex].text;
        mainTitleH1.innerHTML = `Конструктор Претензий (${selectedOptionType})`
        ...
        switch (selectedOptionType) {
            case "Некачественная услуга":
                ...
                newOption6.value = '3';
                newOption6.text = 'Возмещение расходов на устранение недостатков третьими лицами'
                ...
                goodDiv.placeholder = `Пылесос iPhone 11 (2021 г.)`
                ...
                newOption3.value = '3';
                newOption3.text = 'Возмещение расходов на устранение недостатков третьими лицами'
    ...
    checkmark.addEventListener('change', () => {
        ...
        if(isCheckmark) {
            ...
            console.log("чекнул");
            console.log(isCheckmark);
        } else {
            moralDiv.style.display = `none`
            console.log("не чекнул");
            console.log(isCheckmark);
        }
    })
    ...
    document.querySelector("button").addEventListener("click", function() {
        ...
        const complaint = document.querySelector("#complaint")?.value.trim().toLowerCase() || "";
        ...
        //НЕКАЧЕСТВЕННЫЙ ТОВАР!!!!!!!
            if(tovarNek) {
                ...
                firstParagraphs.push(new Paragraph({
                ...
                if(selectedOption === "Возврат денежных средств" || selectedOption === "") {
                    ...
                    new Paragraph({
                        ...
                        children: [
                            new TextRun({
                                text: `${count = count + 1}. Вернуть уплаченные мной денежные средства по договору в размере ${price} белорусских рублей${moralAmount ? ";" : "."}`,
                                font: "Times New Roman",
                                size: 28, // 14 pt = 28 half-points
                            }),
                        ],
                ...
                console.log(paragraphs);
                    ...
                    paragraphs.push(new Paragraph({
                        ...
                        children: [
                            new TextRun({
                                text: `${count}. Осуществить замену товара ненадлежащего качества на товар надлежащего качества в срок не позднее 14 дней с момента получения настоящей претензии${moralAmount ? ";" : "."}`,
                                font: "Times New Roman",
                                size: 28, // 14 pt = 28 half-points
                            }),
                        ],
                    ...
                    paragraphs.push(new Paragraph({
                        ...
                        children: [
                            new TextRun({
                                text: `${count}. Безвозмездно устранить вышеизложенные недостатки товара не позднее 14 дней с момента получения настоящей претензии${moralAmount ? ";" : "."}`,
                                font: "Times New Roman",
                                size: 28, // 14 pt = 28 half-points
                            }),
                        ],
                    ...
                    paragraphs.push(new Paragraph({
                        ...
                        children: [
                            new TextRun({
                                text: `${count}. Соразмерно уменьшить стоимость товара на ${sorazmAmount} белорусских рублей${moralAmount ? ";" : "."}`,
                                font: "Times New Roman",
                                size: 28, // 14 pt = 28 half-points
                            }),
                        ],
                ...
                paragraphs0.push(new Paragraph({
                ...
                } else if(selectedOption === "Возмещение расходов на устранение недостатков третьими лицами") {
                    ...
                    paragraphs.push(new Paragraph({
                        ...
                        children: [
                            new TextRun({
                                text: `${count}. Возместить расходы на устранение недостатка(-ов) товара общей стоимостью в ${vozmAmount} белорусских рублей${moralAmount ? ";" : "."}`,
                                font: "Times New Roman",
                                size: 28, // 14 pt = 28 half-points
                            }),
                        ],
            ...
            // НЕКАЧЕСТВЕННАЯ УСЛУГА!!!!!!
                ...
                pravoParagraphs.push(new Paragraph({
                    alignment: AlignmentType.JUSTIFIED,
                    indent: { firstLine: 708 },
                    children: [
                        new TextRun({
                ...
                if(selectedOption === "Возврат денежных средств") {
                ...
                } else if(selectedOption === "Безвозмездное устранение недостатков" || selectedOption === "") {
                    ...
                    paragraphs.push(new Paragraph({
                        ...
                        children: [
                            new TextRun({
                                text: `${count}. Безвозмездно устранить вышеизложенные недостатки услуги (работы) не позднее 14 дней с момента получения настоящей претензии${moralAmount ? ";" : "."}`,
                                font: "Times New Roman",
                                size: 28, // 14 pt = 28 half-points
                            }),
                        ],
                   ...
                   daysForOtvet = 7
                    paragraphs.push(new Paragraph({
                        ...
                        children: [
                            new TextRun({
                                text: `${count}. Соразмерно уменьшить стоимость услуги (работы) на ${sorazmAmount} белорусских рублей${moralAmount ? ";" : "."}`,
                                font: "Times New Roman",
                                size: 28, // 14 pt = 28 half-points
                            }),
                        ],
                ...
                paragraphs0.push(new Paragraph({
                    ...
                    paragraphs.push(new Paragraph({
                        ...
                        children: [
                            new TextRun({
                                text: `${count}. Возместить расходы на устранение недостатка(-ов) услуги (работы) общей стоимостью в ${vozmAmount} белорусских рублей${moralAmount ? ";" : "."}`,
                                font: "Times New Roman",
                                size: 28, // 14 pt = 28 half-points
                            }),
                        ],
            ...
            /// НАРУШЕНИЕ СРОКОВ ПЕРЕДАЧИ ТОВАРА
                ...
                if(penaltyCheckmark.checked) {
                    const [days, penalty] = calculatePenalty(getCurrentDate(), penaltyDate)
                    penaltyTovarSize = penalty
                    console.log(days, penalty, penaltyDate, getCurrentDate());
                    ...
                    pravoParagraphs.push(new Paragraph({
                        ...
                        children: [
                            new TextRun({
                                text: `${price} × 9,75 % / 365 × ${days} = ${penalty} белорусских рублей, где:`,
                                font: "Times New Roman",
                                size: 28, // 14 pt = 28 half-points
                            }),
                        ],
                    ...
                    pravoParagraphs.push(new Paragraph({
                        ...
                        children: [
                            new TextRun({
                                text: `9,75 % – ставка рефинансирования Национального Банка Республики Беларусь на день составления настоящей претензии;`,
                                font: "Times New Roman",
                                size: 28, // 14 pt = 28 half-points
                            }),
                        ],
                    ...
                    pravoParagraphs.push(new Paragraph({
                        ...
                        children: [
                            new TextRun({
                                text: `365 – количество дней в настоящем календарном году;`,
                                font: "Times New Roman",
                                size: 28, // 14 pt = 28 half-points
                            }),
                        ],
                    ...
                    pravoParagraphs.push(new Paragraph({
                        ...
                        children: [
                            new TextRun({
                                text: `${days} – количество дней просрочки: с ${penaltyDate} по ${getCurrentDate()}.`,
                                font: "Times New Roman",
                                size: 28, // 14 pt = 28 half-points
                            }),
                        ],
                ...
                paragraphs.push(new Paragraph({
                    ...
                    children: [
                        new TextRun({
                            text: `${count}. Вернуть мне уплаченные по договору денежные средства в размере ${price} белорусских рублей${moralAmount || penaltyCheckmark.checked ? ";" : "."}`,
                            font: "Times New Roman",
                            size: 28, // 14 pt = 28 half-points
                        }),
                    ],
                ...
                paragraphs.push(new Paragraph({
                    ...
                    children: [
                        new TextRun({
                            text: `${count = count + 1}. Выплатить мне проценты за несвоевременную доставку товара в размере ${penaltyTovarSize} белорусских рублей${moralAmount ? ";" : "."}`,
                            font: "Times New Roman",
                            size: 28, // 14 pt = 28 half-points
                        }),
                    ],
            ...
            ///НАРУШЕНИЕ СРОКОВ ОКАЗАНИЯ УСЛУГ (ВЫПОЛНЕНИЯ РАБОТ)
                ...
                if(penaltyCheckmark.checked) {
                   ...
                   console.log(days, penalty, penaltyUslugiSize, getCurrentDate(), penaltyDate);
                ...
                pravoParagraphs.push(new Paragraph({
                    ...
                    children: [
                        new TextRun({
                            text: `${days} – количество дней просрочки исполнения обязательств с ${penaltyDate} по ${getCurrentDate()}.`,
                            font: "Times New Roman",
                            size: 28, // 14 pt = 28 half-points
                        }),
                    ],
                ...
                paragraphs.push(new Paragraph({
                    ...
                    children: [
                        new TextRun({
                            text: `${count}. Расторгнуть заключенный между нами договор оказания услуг (выполнения работ) и вернуть мне уплаченные по договору денежные средства в размере ${price} белорусских рублей${moralAmount || penaltyCheckmark.checked ? ";" : "."}`,
                            font: "Times New Roman",
                            size: 28, // 14 pt = 28 half-points
                        }),
                    ],
                ...
                if(penaltyCheckmark.checked) {
                    paragraphs.push(new Paragraph({
                        ...
                        children: [
                            new TextRun({
                                text: `${count = count + 1}. Выплатить мне неустойку за несвоевременное исполнение обязательств по договору в размере ${penaltyUslugiSize} белорусских рублей${moralAmount ? ";" : "."}`,
                                font: "Times New Roman",
                                size: 28, // 14 pt = 28 half-points
                            }),
            ...
            /// ОДНОСТОРОННИЙ ОТКАЗ!!!
                ...
                paragraphs.push(new Paragraph({
                    ...
                    children: [
                        new TextRun({
                            text: `${count = count + 1} Предоставить документы подтверждающие фактически понесенные расходы по состоянию на дату составления претензии по договору об оказании услуг (выполнении работ)${moralAmount ? ";" : "."}`,
                            font: "Times New Roman",
                            size: 28, // 14 pt = 28 half-points
                        }),
                    ],
            ...
            if(moralAmount) {
                moralParagraph.push(new Paragraph({
                    alignment: AlignmentType.JUSTIFIED,
                    indent: { firstLine: 708 },
                    children: [
                        new TextRun({
                            text: `${count = count + 1}. Выплатить мне компенсацию понесенного морального вреда в размере ${moralAmount} белорусских рублей.`,
                            font: "Times New Roman",
                            size: 28, // 14 pt = 28 half-points
                        }),
                    ],
...
function calculatePenalty(todaysDateStr, penaltyDateStr) {
    ...
    if(srokiUslug) {
        ...
        penalty = parseFloat(innerPrice) * refinancingRate / 365 * daysDifference
    }
